...
public class AjouterUnNouveauArticle extends JPanel implements ActionListener {
	...
	public AjouterUnNouveauArticle(UserInterface gui) {
		...
		this.quantiteEnStockLabel = new JLabel("Quantit� en stock : ");
						...
						if(seuilDeReassortiment > 0) {
							...
							if(prixDeVente > 0) {
								if(vrai.isSelected()) {
									...
									JOptionPane.showMessageDialog(null, "L'article " + nom + " a �tait ajout� avec succ�", "Information", JOptionPane.INFORMATION_MESSAGE);
