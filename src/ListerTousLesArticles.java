...
public class ListerTousLesArticles extends Lister {

	public ListerTousLesArticles(UserInterface gui) {
		super(gui);
	...
	public void paintComponent(Graphics g) {
		...
		g.drawString("La liste de tous les articles", 220, 50);
		...
		this.gui.println(this.gui.getEngine().getDetaillant().listerTousLesArticles(), this.log);
